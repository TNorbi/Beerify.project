...
import backgroundRemoverV2 as bgd
import image_similarity_path as sim
import shutil
import os
import saveBest as svb
import yaml
import image_similarity_v2 as sim2

basepath = 'E:\\Work\\UNI\\Third_year_first_semester\\Szoftver tervezes\\Projekt finished\\V2\\'
...
if __name__ == '__main__':
    ...
    data = sim2.runSimilarity(compressedDirectory, imageToCompare)
